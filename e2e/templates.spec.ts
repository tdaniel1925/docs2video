...
test.describe('Template Management', () => {
  ...
  test.skip('+ Create template opens the wizard', async ({ page }) => {
    await page.goto('/templates')
  ...
  test.skip('AI chat interface is visible in describe step', async ({ page }) => {
    await page.goto('/templates/new')
    const chatInterface = page.locator('[data-testid="ai-chat"], [class*="chat"], textarea[placeholder*="describe"]').first()
    await expect(chatInterface).toBeVisible()
  })

  test.skip('reference image upload zone exists', async ({ page }) => {
    await page.goto('/templates/new')
