    ...
    <>
      ...
      <div className="container">
        <section className="hero hero-split" style={{ marginTop: 20 }}>
          ...
          <div className="hero-right">
            <ClickToPlayVideo src="https://izccljcgxsbumgsznndd.supabase.co/storage/v1/object/public/videos/site-assets/industry-demos/legal.mp4" style={{ boxShadow: '0 12px 40px rgba(0,0,0,0.15)' }} />
          </div>
        </section>
      </div>
      ...
      <div className="container">
        <section className="final-cta">
          ...
          <p className="final-cta-sub">Informed clients are better clients. Start free — cancel anytime.</p>
