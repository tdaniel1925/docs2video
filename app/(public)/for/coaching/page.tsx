    ...
    <>
      ...
      <div className="container">
        <section className="hero hero-split" style={{ marginTop: 20 }}>
          ...
          <div className="hero-right">
            <ClickToPlayVideo src="/industry-demos/coaching.mp4" style={{ boxShadow: '0 12px 40px rgba(0,0,0,0.15)' }} />
          </div>
        </section>
      </div>
      ...
      <div className="container">
        <section className="final-cta">
          ...
          <p className="final-cta-sub">Stop blending in with every other coach. Start your free trial today — no credit card required.</p>
