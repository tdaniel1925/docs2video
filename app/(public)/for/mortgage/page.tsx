    ...
    <>
      ...
      <div className="container">
        <section className="hero hero-split" style={{ marginTop: 20 }}>
          ...
          <div className="hero-right">
            <ClickToPlayVideo src="/industry-demos/mortgage.mp4" style={{ boxShadow: '0 12px 40px rgba(0,0,0,0.15)' }} />
          </div>
        </section>
      </div>
      ...
      <div className="container">
        <section className="final-cta">
          ...
          <p className="final-cta-sub">Be the loan officer who actually makes it make sense. Start free — no credit card required.</p>
