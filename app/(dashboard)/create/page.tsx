...
type Step = 'upload' | 'extracting' | 'detail-level' | 'script' | 'options' | 'generating' | 'done'
...
export default function CreatePage() {
  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        ...
        if (brandsError) {
          console.error('[create] Failed to load brands:', brandsError.message)
        } else if (data) {
        ...
        console.error('[create] Brand loading error:', err)
      }
  ...
  }, [extractedData, generalData, editableScenes, selectedVoice, selectedStyle, selectedBrand, detailLevel, videoPurpose, selectedIndustry, aiMusic, musicPrompt, step])
  ...
  function restoreDraft() {
    try {
      ...
      if (draft.musicPrompt) setMusicPrompt(draft.musicPrompt)
