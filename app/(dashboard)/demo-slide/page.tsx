...
export default function DemoSlidePage() {
  ...
  const [prompt, setPrompt] = useState('Create a stunning, cinematic, high-quality presentation slide using this logo. Use photorealistic AI-generated backgrounds with depth, lighting, and atmosphere. Bold modern typography with layered panels and dynamic composition. Rich visual storytelling — not flat or illustrative. Think premium agency pitch deck quality. 1920x1080 landscape.')
