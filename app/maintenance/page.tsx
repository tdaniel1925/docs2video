  ...
  return (
    <main style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', background: '#F4F1EC', color: '#1B3A5C', padding: 24, fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>
      <div style={{ maxWidth: 560, width: '100%', background: '#fff', borderRadius: 10, padding: '40px 36px', boxShadow: '0 20px 60px rgba(27,58,92,.12)', textAlign: 'center' }}>
        ...
        {/* A DAY, NOT "SOON". "Very soon" tells a waiting customer nothing and
            reads as indefinite; a named day lets them plan around it. */}
        <p style={{ fontSize: 17, lineHeight: 1.5, margin: '0 0 22px', color: '#3D5A7A' }}>Docs2Video and Text2Art are getting a major upgrade and will be back <strong>on Monday</strong>. Your account, videos, artwork and credits are safe — nothing is lost during the upgrade.</p>
