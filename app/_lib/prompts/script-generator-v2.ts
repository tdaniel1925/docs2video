...
S2. AVOID FILLER
- Instead of "It's important to note that revenue is up", say "Revenue is up".
- Instead of "Let's take a look at the data", just present the data.
- Instead of starting a sentence with "Now," or "So," or "Additionally," or "Furthermore,", start with the substance.
