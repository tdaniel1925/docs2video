...
await crawl(p, ['/', '/deck', '/powerpoint', '/pptx', '/pack', '/sizes', '/brands', '/library', '/account', '/admin', '/admin/customers', '/admin/jobs', '/admin/money', '/admin/settings', '/admin/health', '/admin/audit'], 'USER')
await b.close()
